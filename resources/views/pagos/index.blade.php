...
<div class="container">
    <div class="card border shadow-sm rounded-4">
        <div class="card-body p-4">
            <h4 class="mb-4">Entradas de inventario</h4>
            <div class="alert akert-light border rounded-4">
                <div class="row">
                    <div class="col-md-10" style="padding-bottom: 0.5rem">
                        @if(Auth::user()->rol == 1)
                            <div class="col-md-4">
                ...
                <div class="table-responsive">
                    <table id="tbl_lista_pagos" class="table table-borderless table-centered">
